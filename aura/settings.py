...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-gyirc!e5%)^jqphraire(+ne6a4#+%4b917vxyulgy_wk&isvo')
...
# CORS configuration
CORS_ALLOW_ALL_ORIGINS = True # Em produção, configure CORS_ALLOWED_ORIGINS especificamente
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Aura API',
    'DESCRIPTION': 'Documentação da API para o ecossistema Aura (gestão e agendamentos para salões de beleza).',
    'VERSION': '1.0.0',
